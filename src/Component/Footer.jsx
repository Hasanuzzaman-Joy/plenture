...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-horizontal w-full md:max-w-7xl px-4 md:px-0 mx-auto footer-center bg-[#43d58552] text-base-content p-10">
            <div className="w-full md:w-11/12 mx-auto flex flex-col items-center gap-12">
