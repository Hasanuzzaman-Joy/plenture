...
const About = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 w-full gap-6 mt-7 md:mt-20 md:px-0 px-4'>
            <div>
                <h1 className='text-4xl font-bold mb-5 text-center md:text-left'>About Us</h1>
