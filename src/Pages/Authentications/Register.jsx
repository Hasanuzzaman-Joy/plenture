...
const Register = () => {
    ...
    return (
        <div className=' bg-[#f4f3f3] dark:bg-[#000000] w-full md:w-11/12 mx-auto py-10 md:px-0 px-4'>
            <ToastContainer />
            <div className="w-full max-w-md mx-auto bg-base-100 dark:bg-[#0a0c13] dark:border-white dark:border-[1px] p-4 rounded-md sm:p-8 shadow-xl" style={{
                boxShadow:
                    'rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px',
            }}>
                <h2 className="mb-3 text-3xl font-bold text-center">Register Account</h2>
                <div className="my-6 space-y-4">
                    <div onClick={registerGoogle} className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md btn hover:bg-transparent bg-[#006838] text-white hover:text-black text-base tracking-wider font-semibold border-gray-300">
                        <FcGoogle />
                ...
                <form onSubmit={registerForm} className="space-y-8">
                    ...
                    <button
                        type="submit"
                        className="w-full px-8 py-2 font-semibold rounded-md bg-[#006838] hover:bg-[#40b93c] text-white border border-transparent hover:border-gray-300 text-base cursor-pointer transition-all"
                    >
                        Register Now
                    </button>
                    <div>
