            ...
            <div className="w-full md:w-11/12 max-w-7xl mx-auto flex flex-col md:flex-row min-h-[600px] rounded-md overflow-hidden shadow-xl">
                ...
                <div className="flex flex-1 justify-center items-center bg-base-100 p-4 sm:p-8 dark:bg-[#0a0c13] dark:border-white dark:border"
                    ...
                    <div className="w-full md:w-[92%]">
                        <h2 className="mb-3 text-3xl font-bold">Create Plenture Account</h2>
                        ...
                        <form onSubmit={registerForm} className="space-y-8">
                            <div className="grid grid-cols-2 gap-4">
                                {err && <p className='text-sm text-red-600 col-span-2'>{err}</p>}

                                <div className="space-y-2">
                                    <label htmlFor="name" className="block text-sm font-semibold">Name</label>
                                    <input type="text" name="name" id="name" placeholder="Your Name" className="w-full px-3 py-2 border rounded-md bg-gray-50 text-gray-800 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#40b93c]" />
                                </div>

                                <div className="space-y-2">
                                    <label htmlFor="photo" className="block text-sm font-semibold">Photo URL</label>
                                    <input type="text" name="photo" id="photo" placeholder="Your Photo URL" className="w-full px-3 py-2 border rounded-md bg-gray-50 text-gray-800 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#40b93c]" />
                                </div>

                                <div className="space-y-2">
                                    <label htmlFor="email" className="block text-sm font-semibold">Email Address</label>
                                    <input type="email" name="email" id="email" placeholder="abc@gmail.com" className="w-full px-3 py-2 border rounded-md bg-gray-50 text-gray-800 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#40b93c]" required />
                                </div>
                            ...
                            <div>
                                <p className='text-sm mt-7'>Already have an account? <Link to='/login' className='text-[#40b93c] font-bold hover:underline'>Sign In</Link></p>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div className="flex-1 hidden md:flex flex-col justify-center items-center px-10 bg-[#DFFFE1]">
                    <img src="https://i.ibb.co/6cBHF4Kb/Mobile-login-bro.png" alt="Illustration" className="max-w-full max-h-full object-contain" />
                </div>
            </div>
        </div>
    );
