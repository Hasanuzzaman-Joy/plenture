                            ...
                            plantItem.map((plant, index) => (
                                <tr>
                                    ...
                                    <td className="flex gap-2">
                                        <Link to={`/updatePlant/${plant._id}`} className='btn bg-[#006838] text-white md:px-8'>Update</Link>
                                        <button onClick={() => handleDelete(plant._id)} className='btn bg-[#006838] text-white md:px-8'>Delete</button>
                                    </td>
                                </tr>
                            ))
                        }
